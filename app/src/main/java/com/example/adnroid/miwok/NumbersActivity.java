...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] defaultTranslation = getResources().getStringArray(R.array.numbers_default);
        // Get the Miwok translation of words from array resource file and put them in Array object
        String[] miwokTransaltion = getResources().getStringArray(R.array.numbers_miwok);
        // Get the resource ID of icons for words from array resource file and put them in TypedArray object
        final TypedArray icon = getResources().obtainTypedArray(R.array.numbers_icon);
        // Get the resource ID of audio files for words from array resource file and put them in TypedArray object
        final TypedArray audio = getResources().obtainTypedArray(R.array.numbers_audio);
